    ...
    return (
      <div className="rounded-lg border border-green-200 bg-green-50 p-4 text-sm text-green-800">
        ...
        <p className="mt-1 text-xs text-green-700">
          Bu şifre bir daha gösterilmeyecek — kullanıcıya iletin, ilk girişte değiştirmesini isteyin.
        </p>
      </div>
    );
  }
    ...
    <form action={formAction} className="flex flex-col gap-3 rounded-lg border border-card-border p-4">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        ...
        <div className="flex flex-col gap-1">
          ...
          <select name="role" defaultValue="pv_sales" className={inputClass}>
            <option value="pv_admin">Admin</option>
            <option value="pv_sales">Satış</option>
