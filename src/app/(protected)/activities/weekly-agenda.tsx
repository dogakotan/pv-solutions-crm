...
import { addDays, formatWeekRangeLabel, getMonday, isSameDay, toDateParam, WEEKDAY_LABELS } from "./calendar-utils";
...
export function WeeklyAgenda({
  ...
  const prevWeekHref = `/activities?view=calendar&mode=week&week=${toDateParam(addDays(weekStart, -7))}`;
  const nextWeekHref = `/activities?view=calendar&mode=week&week=${toDateParam(addDays(weekStart, 7))}`;
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        {!isCurrentWeek && (
          <Link
            href="/activities?view=calendar&mode=week"
